...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li   class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!schoolavgsocore.action">学校平均成绩</a></li>
    </ul>                
</div> 
...
<div class="form-group"> 
	...
	<div class="form-group">
	  	<label>数据说明：各项平均成绩=学校学员各项总成绩/学校学员学习人数	</label>
	</div>
</div>       
...
function loadHighchart(){	
	    $('#container').highcharts({
	        ...
	        title: {
	            text: $('#clazzId :selected').text()+'班级平均成绩柱状图 ',
				style: {
					color: '#4572A7' 
				}
	        },
...
function initData(){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getschoolscorecountdata.excsec?clazzId="+$("#clazzId").val()+"&scoretype=7",function(data) {
