...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programsavgstudytime.action">项目平均学习时间</a></li>
...
<div class="form-group" style="float: left"> 
	...
	<div class="form-group">
	  	<label>数据说明：项目平均学习时间 = 项目的总学习时间/项目报名人数</label>
	</div>
</div>       
...
function initData(){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getprogramsavgstudycountdata.excsec?tenantId="+$("#tenantId").val(),function(data) {
