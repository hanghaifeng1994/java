...
//        }
        ...
        if (rabbitProperties.getConnectionTimeout() != null) {
            Long tt = rabbitProperties.getConnectionTimeout().getSeconds();
            factory.setConnectionTimeout(tt.intValue());
        }
...
//        connectionFactory.setPublisherReturns(rabbitProperties.isPublisherReturns());
        ...
        if (rabbitProperties.getCache().getChannel().getCheckoutTimeout() != null) {
            Long tt = rabbitProperties.getCache().getChannel().getCheckoutTimeout().getSeconds();
            connectionFactory.setChannelCheckoutTimeout(tt.intValue());
        }
