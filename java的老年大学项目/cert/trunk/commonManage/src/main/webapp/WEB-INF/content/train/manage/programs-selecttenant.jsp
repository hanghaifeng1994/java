...
<div class="panel panel-default">
	<div class="btn-toolbar dr-btn-toolbar">
		<div class="btn-group">
				<button  name="Submit2" class="btn btn-default btn-sm" type="button" id="allDown" >
                <span class="glyphicon glyphicon-eye-open"></span>&nbsp;全部下发
           		</button>
		</div>
	</div>
</div>
<form id="form1" action="programs!programDown.action" method="post" class="form-horizontal dr-form-bordered" role="form">
...
<div class="col-md-offset-2 col-md-10">
    ...
    <div class="btn-group">
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='programs.action'">
