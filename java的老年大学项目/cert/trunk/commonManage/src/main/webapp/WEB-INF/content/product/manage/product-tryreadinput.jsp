...
<title>书籍试读版本管理<s:if test="currentTenant!=null">-${currentTenant.logo}</s:if><s:else><%@ include file="/common/title.jsp" %></s:else></title>
...
{
	 $.get("${ctx}/product/manage/product!tryreadVideoDelete.excsec", {id:id}, function (data){
   	 if(data!="")
			alert(data);
...
<div class="dr-wrapper"> 
    <section id="main" role="main"> 
      ...
      <ol class="dr-breadcrumb">
        <li><span class="glyphicon glyphicon-home"></span>&nbsp;<a href="#">书籍管理</a></li>
        <li class="active">书籍试读版本管理</li>
       </ol>
   <div class="dr-page-header">
     <h3>书籍试读版本管理 </h3>
   </div>
   <hr/>
<form id="inputForm" class="form-horizontal dr-form-bordered" name="inputForm" action="product!saveRryread.action" method="post" enctype="multipart/form-data" onsubmit="return submitForm();">
<div class="tab-content dr-tabs-panel" style="padding: 0px;">
	  <input id="id" name="id" type="hidden" value="${product.id}" size="30" />
     ...
     <span class="help-block">提醒：请上传wmv、mp4、flv等视频文件格式作为书籍试读版本：</span>
     </div>
     <div class="col-md-3">
      <s:if test="product.tryreadFile!=null">
	      	<span>目前视频文件：${product.tryreadFile}</span>
	      </s:if>
     </div>
...
<div class="col-md-offset-2 col-md-10">	
		...
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="cleartryreadvideo(${product.id})">
