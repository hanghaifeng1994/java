...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!schoolhegecomplete.action">学校合格情况</a></li>
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!schoolscore.action">学校各项成绩</a></li>
        <li   class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!schoolscorecomplete.action">学校得分率情况</a></li>
...
<div class="form-group" id="highchart_type" style="width: 100%;">       
 		<label>图表信息: </label>    
	  	<button class="btn btn-sm highchart-btn" type="button"   onclick="loadHighchart(1)" id="highchart_1">课程学习</button>
	    <button class="btn btn-sm " type="button"   onclick="loadHighchart(2)" id="highchart_2">作业成绩</button>
	    <button class="btn btn-sm " type="button"   onclick="loadHighchart(3)" id="highchart_3">研修成果</button>
		<button class="btn btn-sm " type="button"   onclick="loadHighchart(4)" id="highchart_4">研修讨论</button>
		<button class="btn btn-sm " type="button"   onclick="loadHighchart(5)" id="highchart_5">研修日志</button>
		<button class="btn btn-sm " type="button"   onclick="loadHighchart(6)" id="highchart_6">简报成绩</button>
</div>     
...
<div class="form-group">
	  	<label>数据说明：各项得分率=学校学员各项总成绩/学校学员学习人数/各项总分	</label>
	</div>
</div>       
...
function initData(type){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getschoolscorecompletedata.excsec?programesId="+$("#programesId").val()+"&clazzId="+$("#clazzId").val()+"&scoretype="+type,function(data) {
