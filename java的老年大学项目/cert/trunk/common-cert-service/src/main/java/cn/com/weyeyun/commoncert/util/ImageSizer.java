...
public class ImageSizer {
     ...
     */
	public static void imageResize(File originalFile, File resizedFile, int maxWidth, float quality) throws IOException {
		if (quality > 1) {
		...
		resizedImage = i.getScaledInstance(newWidth, (newWidth * iHeight) / iWidth, Image.SCALE_SMOOTH);//按宽度等比例缩放
