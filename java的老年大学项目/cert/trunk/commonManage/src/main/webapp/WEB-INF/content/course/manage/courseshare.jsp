    ...
    $(document).ready(function(){
	   ...
	   $("#checked").click(
			   function(){
				   ...
				   document.getElementById("deleteForm").action="${ctx }/course/manage/courseshare!checked.action";
			       if(!checkSelect()) {
			            b_alert("没有可操作记录,请勾选");
			            return false;
			       } 
	   ...
	   $("#unchecked").click(
			   function(){
				   var oaction = document.getElementById("deleteForm").action;
				   document.getElementById("deleteForm").action="${ctx }/course/manage/courseshare!unchecked.action";
			       if(!checkSelect()) {
			            b_alert("没有可操作记录,请勾选");
			            return false;
			       } 
...
<ul class="nav nav-tabs nav-justified">
 	...
 	<li class="active"><a href="courseshare.action">分享审核</a></li>
</ul>
<div class="tab-content dr-tabs-panel">
<form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/course/manage/courseshare.action" method="post">
...
<table class="table table-bordered dr-table-default">
	...
	<s:iterator value="page.result" status="stat">
		<tr>
			...
			<td>${checkedStr }</td>
			<td>
				<a href="${ctx }/course/manage/courseshare!checked.action?ids=${id}">
				<button class="btn btn-primary btn-sm" type="button">
					<span class="glyphicon glyphicon-bullhorn"></span>&nbsp;审核通过
				</button>
				</a>
				<a href="${ctx }/course/manage/courseshare!unchecked.action?ids=${id}">
