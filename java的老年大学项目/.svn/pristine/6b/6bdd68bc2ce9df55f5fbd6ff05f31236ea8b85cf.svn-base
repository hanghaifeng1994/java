...
<form id="form1" action="<s:if test="isIssue">notice!noticeIssued.action?isMy=true</s:if><s:else>notice!noticeCancleIssued.action?isMy=true</s:else>" method="post" class="form-horizontal dr-form-bordered" role="form">
<input type="hidden" name="noticeIds" value="${noticeIds}" />
...
<div class="col-md-offset-2 col-md-10">
    ...
    <div class="btn-group">
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='notice.action'">
