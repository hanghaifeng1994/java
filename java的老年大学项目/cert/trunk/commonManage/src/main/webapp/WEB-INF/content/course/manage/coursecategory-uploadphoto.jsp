...
$(document).ready(function() { 
	...
	//设置剪裁参数 
	setJcrop(0,0,294,170,"<common:prop name='traincore.uploadpath.url' propfilename=''></common:prop>","${picfileFileName}","${ctx}/course/manage/coursecategory!ajaxCutStuPic.excsec","${ctx}/upload!uploadCourseImage.excsec");		
});
...
<section id="main" role="main"> 
 ...
 <div  class="dr-searchbar">
			...
			<iframe name="uploadimage" id="uploadimage" src="coursecategory!uploadpic.action" frameborder="0"  style="overflow-x:none" width="150px" height="30px" scrolling="no"></iframe>			
