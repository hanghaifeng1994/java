...
<div class="dr-wrapper">
	...
	<!--breadcrumb-->
       ...
       <li class="active"><span>项目学情</span></li>
      </ol>
	<!--/breadcrumb-->
	<!--页面标题-->
<div>
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab" style="padding: 0px;">
        <li class="active"><a style="cursor: pointer;" href="${ctx }/count/manage/learningsituation!programes.action">项目学情统计</a></li>
        <li><a style="cursor: pointer;" href="${ctx }/count/manage/learningsituation!programeshighchart.action">项目图表统计</a></li>
    </ul>                
</div> 

<form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/count/manage/learningsituation!programes.action" method="post">
...
<table class="table table-bordered dr-table-default">
 ...
 <s:iterator value="learninglist" status="stat">
		<tr>
			<td width="80px;">${programesName}</td>
