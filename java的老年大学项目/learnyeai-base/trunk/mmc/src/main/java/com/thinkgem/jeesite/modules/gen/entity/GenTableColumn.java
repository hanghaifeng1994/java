...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	public String getJdbcType1() {
		String type = null;
		// 设置java类型
		if (StringUtils.startsWithIgnoreCase(getJdbcType(), "CHAR"))
			type = "CHAR";
		else if( StringUtils.startsWithIgnoreCase(getJdbcType(), "VARCHAR")
				|| StringUtils.startsWithIgnoreCase(getJdbcType(), "NARCHAR")){
			type = "VARCHAR";
		}else if (StringUtils.startsWithIgnoreCase(getJdbcType(), "DATETIME")
				|| StringUtils.startsWithIgnoreCase(getJdbcType(), "DATE")
				|| StringUtils.startsWithIgnoreCase(getJdbcType(), "TIMESTAMP")){
			type = "TIMESTAMP";
		}else if(StringUtils.startsWithIgnoreCase(getJdbcType(), "INT"))
			type = "BIGINT";
		else if (StringUtils.startsWithIgnoreCase(getJdbcType(), "BIGINT")
