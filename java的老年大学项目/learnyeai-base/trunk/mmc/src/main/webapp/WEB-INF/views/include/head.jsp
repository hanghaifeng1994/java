...
<link href="${ctxStatic}/jquery-select2/4.0/select2.min.css" rel="stylesheet" />
<script src="${ctxStatic}/jquery-select2/4.0/select2.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery-select2/4.0/i18n/zh-CN.js" type="text/javascript"></script>
...
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';var resourcePath = '${resourcePath}';</script>

<script src="${ctxStatic}/appPicUpload/js/pnc.js" type="text/javascript"></script>