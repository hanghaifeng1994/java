 ...
 * @author zhangpz
 */
public class ShAppletSetting extends BaseEntity {

    /**
    * 小程序配置id
    */
    @Id
    @Column(name = "APLT_SET_ID")
     ...
     */
    @Column(name = "APP_SIGNS")
    private String appSigns;
    /**
     * 接口调用凭据刷新令牌
     */
    @Column(name = "APP_AUTH_REFRESH_TOKEN")
    private String appAuthRefreshToken;
    /**
     * 授权信息
     */
    @Column(name = "APP_AUTH_INFO")
    private String appAuthInfo;
    /**
     * 商户名称
     */
    @Column(name = "WECHAT_MERCHANT_NAME")
    private String wechatMerchantName;
    /**
     * 商户号
     */
    @Column(name = "WECHAT_MERCHANT_NUM")
    private String wechatMerchantNum;
    /**
     * 商户密钥
     */
    @Column(name = "WECHAT__MERCHANT_PASSWOD")
    private String wechatMerchantPasswod;
    /**
     * 公众号名称
     */
    @Column(name = "PUBLIC_NUM_NAME")
    private String publicNumName;
    /**
     * 公众号appid
     */
    @Column(name = "PUBLIC_NUM_APPID")
    private String publicNumAppid;
    /**
     * 公众号appsecrete
     */
    @Column(name = "PUBLIC_NUM_APPSECRETE")
    ...
    public static class TF {
        ...
        public static String appAuthInfo = "APP_AUTH_INFO";  // 授权信息
        ...
        public static String appExtJson = "APP_EXT_JSON";  // 模板小程序扩展信息，不包含APPID，使用时再做拼json串
        ...
        public static String appRevertStatus = "APP_REVERT_STATUS";  // 版本回退状态：0未回退、1回退成功、2回退失败
