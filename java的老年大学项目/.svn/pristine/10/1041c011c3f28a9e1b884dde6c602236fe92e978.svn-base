...
$(document).ready(function() { 
	...
	//设置剪裁参数 
	setJcrop(0,0,140,185,"<common:prop name='traincore.uploadpath.url' propfilename=''></common:prop>","${picfileFileName}","${ctx}/product/manage/product!ajaxCutStuPic.excsec","${ctx}/upload!uploadProductImage.excsec");		
});
...
<section id="main" role="main"> 
 ...
 <div  class="dr-searchbar">
			...
			<iframe name="uploadimage" id="uploadimage" src="product!uploadpic.excsec" frameborder="0"  style="overflow-x:none" width="150px" height="30px" scrolling="no"></iframe>			
