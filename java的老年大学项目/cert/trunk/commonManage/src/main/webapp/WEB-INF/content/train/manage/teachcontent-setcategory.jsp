...
<body>
<form id="dataForm" action="${ctx}/train/manage/teachcontent!savecategory.action" method="post" class="form-inline dr-form-inline">
	<input type="hidden" name="id" value="${id}"></input>
     ...
     <label>课程类型:</label>
       <input  name="category" value="${category}" class="form-control input-sm" />
     </div>
