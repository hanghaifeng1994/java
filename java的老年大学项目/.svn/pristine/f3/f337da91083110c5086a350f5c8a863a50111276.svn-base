...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programsweek.action">项目一周学习人数</a></li>
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programsavgstudytime.action">项目平均学习时间</a></li>
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programsagestudytime.action">年龄段电脑和app学习时间</a></li>
...
function initData(studytype){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getprogramsagestudytimecountdata.excsec?programesId="+$("#programesId").val()+"&studytype="+studytype,function(data) {
