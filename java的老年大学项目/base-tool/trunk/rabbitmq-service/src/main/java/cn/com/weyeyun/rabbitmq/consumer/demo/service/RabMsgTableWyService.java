...
import cn.com.weyeyun.rabbitmq.bean.MqVo;
import cn.com.weyeyun.rabbitmq.bean.RabbitMetaMessage;
import cn.com.weyeyun.rabbitmq.consumer.demo.model.RabMsgTable;
import cn.com.weyeyun.rabbitmq.consumer.demo.mapper.RabMsgTableMapper;
import cn.com.weyeyun.rabbitmq.consumer.demo.mq.DemoConstans;
import cn.com.weyeyun.rabbitmq.consumer.demo.mq.DemoMq;
...
public class RabMsgTableWyService extends BaseService<RabMsgTable> {
    ...
    public void reSend(RabMsgTable rabMsgTable){
        ...
        rabbitSender.reSendMsg(msg.getMsgId(),sendMsg);
    }
    @Transactional
