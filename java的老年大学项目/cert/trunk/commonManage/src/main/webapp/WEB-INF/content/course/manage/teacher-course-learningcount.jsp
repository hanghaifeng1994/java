...
<form id="mainForm" name="mainForm" action="${ctx}/course/manage/teacher-course!learningcount.action" method="post" class="form-inline dr-form-inline">
...
<form name="deleteForm" id="deleteForm" action="${ctx}/course/manage/teacher-course!learningcount.action" method="GET">
