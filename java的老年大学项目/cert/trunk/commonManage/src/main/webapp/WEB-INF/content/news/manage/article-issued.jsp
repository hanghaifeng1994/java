...
<form id="form1" action="<s:if test="isIssue">article!articleIssued.action</s:if><s:else>article!cancelIssued.action</s:else>" method="post" class="form-horizontal dr-form-bordered" role="form">
...
<div class="form-group" id="validate_finishedneed">
    <s:iterator value="tenantCheckedVOs">
        <div class="checkbox ml10 col-md-10">
          <label>
         <input type="checkbox" <s:if test='isChecked'>checked="checked"</s:if> name="tenantids" id="ids"	value="${tenantDTO.id}" />
             ${tenantDTO.name}
          </label>
        </div>     
  		<div>
...
<div class="col-md-offset-2 col-md-10">
    ...
    <div class="btn-group">
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='article.action?isMy=${isMy}'">
