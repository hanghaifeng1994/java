...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!clazzscorecomplete.action">班级得分率情况</a></li>
...
<div class="form-group">
	  	<label>数据说明：各项得分率=班级学员各项总成绩/班级学员学习人数	/各项总分</label>
	</div>
</div>       
...
function initData(type){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getclazzscorecompletedata.excsec?programesId="+$("#programesId").val()+"&scoretype="+type,function(data) {
