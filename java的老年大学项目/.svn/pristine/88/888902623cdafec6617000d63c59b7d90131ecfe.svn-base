    ...
    $(document).ready(function(){
	   ...
	   $("#applyShare").click(
			   function(){
				   ...
				   document.getElementById("deleteForm").action="${ctx }/product/manage/productshare!shareProduct.action";
			       if(!checkSelect()) {
			            b_alert("没有可操作记录,请勾选");
			            return false;
			       } 
...
<ul class="nav nav-tabs nav-justified">
 	<li class="active"><a href="productshare!apply.action">书籍分享 </a></li>
 	<li><a href="productshare!myapply.action">我的分享申请</a></li>
 	<li><a href="productshare.action">分享审核</a></li>
</ul>
<div class="tab-content dr-tabs-panel">
<form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/product/manage/productshare!apply.action" method="post">
<div class="dr-searchbar">
<input type="hidden" name="productPage.pageNo" id="pageNo" value="${productPage.pageNo}" />
<input type="hidden" name="productPage.orderBy" id="orderBy" value="${productPage.orderBy}" />
<input type="hidden" name="productPage.order" id="order" value="${productPage.order}" />
...
<table class="table table-bordered dr-table-default">
	...
	<s:iterator value="productPage.result" status="stat">
		<tr>
...
<s:set name="page" value="productPage" scope="request"></s:set>
