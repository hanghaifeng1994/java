...
<form id="mainForm" action="teachcontent!newcourse.action" method="post" class="form-inline dr-form-inline">
...
<form id="dataForm" action="${ctx}/train/manage/teachcontent!savecourse.action" method="post" class="form-inline dr-form-inline">
