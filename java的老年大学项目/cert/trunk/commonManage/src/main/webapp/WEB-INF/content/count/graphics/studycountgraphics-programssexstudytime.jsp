...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programssexstudytime.action">性别电脑和app学习时间</a></li>
    </ul>                
</div> 
...
function initData(studytype){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getprogramssexstudytimecountdata.excsec?programesId="+$("#programesId").val()+"&studytype="+studytype,function(data) {
