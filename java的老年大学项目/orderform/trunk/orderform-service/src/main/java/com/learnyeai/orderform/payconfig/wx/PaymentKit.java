...
public class PaymentKit {
	...
	public static Map<String, String> prepayIdCreateSign(String prepay_id) {
		...
		/*packageParams.put("appId", WxPayApiConfigKit.getWxGzhPayConfig().getAppId());
		...
		String packageSign = PaymentKit.createSign(packageParams, WxPayApiConfigKit.getWxGzhPayConfig().getPaternerKey());
