...
public class ResResource extends BaseEntity {
	...
	@Transient
	private List<ResFile> resFiles = new ArrayList<ResFile>();

	@Transient
	private List<String> siteIds;// 站点id列表 用于查询

	@Transient
	private Date resPubStartDate;// 用于查询

	@Transient
	private Date resPubEndDate;// 用于查询
	
	@Transient
	private String resCatnamestr;//分类名称
	...
	public static class TF {
		...
		public static String eduCat = "EDU_CAT"; // 教育大类
	...
	public Date getResPubStartDate() {
		return resPubStartDate;
	}

	public void setResPubStartDate(Date resPubStartDate) {
		this.resPubStartDate = resPubStartDate;
	}

	public Date getResPubEndDate() {
		return resPubEndDate;
	}

	public void setResPubEndDate(Date resPubEndDate) {
		this.resPubEndDate = resPubEndDate;
	}

	public String getResCatnamestr() {
		return resCatnamestr;
	}

	public void setResCatnamestr(String resCatnamestr) {
		this.resCatnamestr = resCatnamestr;
	}
}
