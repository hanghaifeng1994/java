...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li   class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!schoolscore.action">学校各项成绩</a></li>
...
function initData(type){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getschoolscorecountdata.excsec?clazzId="+$("#clazzId").val()+"&scoretype="+type,function(data) {
