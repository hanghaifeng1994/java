...
<form id="form1" name="form1" action="areaschool!save.action" method="post"  class="form-horizontal dr-form-bordered" enctype="multipart/form-data">
...
<input id="parentId" name="parentId" type="hidden" value="${parentId}" size="30"/>
  ...
  <div class="form-group" id="validate_studyphase">
    <label class="col-md-2 control-label">学段<span class="text-danger">*</span></label>
    <div class="col-md-3">
    	<!-- <input type="checkbox" name="studyphase" <s:if test="studyphase">checked="true"</s:if>/>小学&nbsp;&nbsp;&nbsp;
    	<input type="checkbox" name="studyphase" <s:if test="check">checked="true"</s:if>/>初中&nbsp;&nbsp;&nbsp;
    	<input type="checkbox" name="studyphase" <s:if test="check">checked="true"</s:if>/>高中&nbsp;&nbsp;&nbsp;
    	<input type="checkbox" name="studyphase" <s:if test="check">checked="true"</s:if>/>院校&nbsp;&nbsp;&nbsp; -->
    	<s:checkboxlist name="studyphase" list="#{1:'小学  ',2:'初中  ',3:'高中  ',4:'中职  ',5:'院校  '}" listKey="key" listValue="value" value="studyphase" />
    </div>
    <span id="error_studyphase" class="help-block"></span>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="row">
    <div class="col-md-offset-2 col-md-10">
     ...
     <button class="btn btn-default" onclick="window.location.href='areaschool.action?pid=${pid}'" type="button">
