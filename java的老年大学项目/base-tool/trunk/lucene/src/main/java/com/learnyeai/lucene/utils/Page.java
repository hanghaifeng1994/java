...
public class Page<T> {
    ...
    public int getPageNo() {
        if(pageNo <= 0) {
            ...
            int totalPage = getTotalPage();
            if(totalPage > 0 && pageNo > getTotalPage()) {
                pageNo = totalPage;
            }
        }
        return pageNo;
    ...
    public void setAfterDocId(int afterDocId) {
        ...
        if(null == afterDoc || this.afterDocId != afterDocId) {
    ...
    public Page(int pageNo, int pageSize, Collection<T> list) {
        this.pageNo = pageNo;
        this.pageSize = pageSize;
        this.list = list;
    }

    public Page(int pageNo, int pageSize, Collection<T> list, int groupSize) {
        this.pageNo = pageNo;
        this.pageSize = pageSize;
        this.list = list;
        this.groupSize = groupSize;
    ...
    public Page(int pageNo, int pageSize, int groupSize, int afterDocId) {
        this.pageNo = pageNo;
        this.pageSize = pageSize;
        this.groupSize = groupSize;
        this.afterDocId = afterDocId;
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i < totalPage; i++) {
            ...
            System.out.println("当前第" + page.pageNo + "页");
