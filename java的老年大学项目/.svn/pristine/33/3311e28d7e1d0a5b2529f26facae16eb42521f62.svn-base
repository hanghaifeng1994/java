...
<!--信息提示 end-->
   ...
   <form id="mainForm" action="clazz!outplancourse.action" method="post" class="form-inline dr-form-inline">
...
<form id="dataForm"	action="clazz!saveoutplancourse.action"	method="post">
