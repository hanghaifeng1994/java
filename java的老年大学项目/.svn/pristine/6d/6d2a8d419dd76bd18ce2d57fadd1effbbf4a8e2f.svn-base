  ...
  /*  {
   ...
   /* ,{
    ...
    ,{
        ...
        url : "api/itaVote/queryListById.do",
        path : "api/itaVote/queryListById",
        clazz : "PP03"
    },{
        name : "用户-参与业务对象互动的多个用户统计列表",
        url : "api/itaCustExt/queryByOne.do",
        path : "api/itaCustExt/queryByOne",
        clazz : "PP03"
    },{
        ...
        name : "互动次数-增加访问量",
        url : "api/itaInteractionTimes/addReadTimes.do",
        path : "api/itaInteractionTimes/addReadTimes",
        clazz : "PP03"
    },{
        name : "分享-添加",
