 ...
 * @author yl
 */
public class ActActivityWorksVo extends BaseVo {
    ...
    */
    ...
    public static class CF {
        public static String wksId = "wksId";  // id
        public static String actId = "actId";  // 活动id
        public static String wksCode = "wksCode";  // 作品编号
        public static String wksPhoto = "wksPhoto";  // 封面
        public static String wksType = "wksType";  // audio image doc text video stream
        public static String wksFileIds = "wksFileIds";  // 附件ids
        public static String wksFileNames = "wksFileNames";  // 附件名称
        public static String wksUserId = "wksUserId";  // 上传人id
        public static String wksUserName = "wksUserName";  // 上传人名称
        public static String wksUploadDate = "wksUploadDate";  // 上传时间
        public static String wksStatus = "wksStatus";  // 0未提交、1已审核中、2审核通过、3审核失败
        public static String wksAuditId = "wksAuditId";  // 审核id
        public static String wksVoteNum = "wksVoteNum";  // 投票数
        public static String wksAvgScore = "wksAvgScore";  // 平均分
