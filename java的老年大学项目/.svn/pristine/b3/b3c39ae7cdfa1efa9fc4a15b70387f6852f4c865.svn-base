...
public class ImportExcel {
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(String filePath, int headerNum)
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(String filePath, int headerNum, int sheetIndex)
			throws InvalidFormatException, IOException {
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					/*if (StringUtils.isNotBlank(ef.dictType())){
						val = SysDictUtils.getDictValue(val.toString(), ef.dictType(), "");
					...
					if (os[1] instanceof Field){
						...
						Reflections.invokeMethod(e, mthodName, new Object[]{val}, new Class[] {valType});
					}
				}
				sb.append(val+", ");
			}
