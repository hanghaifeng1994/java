...
<form id="mainForm" name="mainForm" action="order!teamlist.action" method="post">
...
<table class="user_search" cellpadding="0" cellspacing="0" border="0"
	...
	<tbody>
		<tr>
			...
			<td width="30%">订单状态 <s:select list="#{'待付':1,'完成':3}" listKey="value" theme="simple"
				listValue="key" headerValue="所有" headerKey="" value="@java.lang.Integer@parseInt(#parameters.filter_EQI_status)"
	name="filter_EQI_status" ></s:select></td>
			<td>&nbsp;</td>
		</tr>
<tr>
			<td>姓名  <input name="filter_LIKES_username"
				class="txt_input mr10" value="${param['filter_LIKES_username']}" />
			...
			<td>金额 <input name="filter_GEN_realPrice"
				class="txt_input mr10" style="width:50px" value="${param['filter_GEN_realPrice']}" />-  <input name="filter_LEN_realPrice"
				class="txt_input mr10" value="${param['filter_LEN_realPrice']}"  style="width:50px" /></td>
			<td align="center"></td>
		</tr>
		<tr>
			...
			<td></td>
			<td align="center"><input name="Submit5" class="search_btu mr5"
