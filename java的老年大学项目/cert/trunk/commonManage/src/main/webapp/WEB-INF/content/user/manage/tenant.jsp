...
<!--信息提示 end-->
<form id="mainForm" name="mainForm" action="tenant.action" class="form-inline dr-form-inline" method="post" enctype="multipart/form-data">
...
<form name="deleteForm" id="deleteForm" action="tenant.action" method="post">
  ...
  <table class="table table-bordered dr-table-bordered" style="font-size: 14px;">
   ...
   <tbody>
    ...
    <tr>
      ...
      <td>${isregtr}</td>
      <td>
      <a href="${ctx}/user/manage/tenant!input.action?id=${id}" class="btn btn-primary btn-sm">
      <span class="glyphicon glyphicon-edit"></span>&nbsp;编辑</a>
        <a href="${ctx}/user/manage/tenant!batchDelete.action?ids=${id}" class="btn btn-default btn-sm">
