...
@Component
public class TestingCourseQueueReceiver extends AbstractMessageListener {
	...
	public boolean receiveMessage(MqVo msg, Object[] result) {
		...
		try {
			map = crsCustLearnCourseWyService.saveTestingQueueCustLearnCourse(obj.getStudentUserId(), obj.getTsId(),
