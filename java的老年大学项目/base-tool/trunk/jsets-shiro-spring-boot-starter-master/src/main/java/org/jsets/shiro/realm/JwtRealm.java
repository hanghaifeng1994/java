...
//    		Set<String> permissions = Commons.split((String)payloadMap.get("perms"));
			...
			if(payloadMap.get("iss") != null) {
				String account = payloadMap.get("iss").toString();
				roles = this.accountProvider.loadRoles(account);
				permissions = this.accountProvider.loadPermissions(account);
			}
