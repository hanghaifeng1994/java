...
public class BaseExcelDownLoad // implements ExcelDownLoad
{
	 ...
	 * @throws IOException
	 */
	public static void downLoad(String inPutFileName, String outPutFileName, HttpServletResponse response) throws IOException {
	 ...
	 * @throws Exception
	 */
	public static void downLoad(String outPutFileName, ExcelModel downExcel, HttpServletResponse response) throws Exception {
		// 取得输出流
	...
	public static String write(String path, String fileName, ExcelModel downExcel) throws Exception {
