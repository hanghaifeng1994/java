    ...
    $(document).ready(function(){
	   ...
	   $("#applyShare").click(
			   function(){
				   ...
				   document.getElementById("deleteForm").action="${ctx }/product/manage/productshare!myapply.action";
			       if(!checkSelect()) {
			            b_alert("没有可操作记录,请勾选");
			            return false;
			       } 
...
<ul class="nav nav-tabs nav-justified">
 	...
 	<li class="active"><a href="productshare!myapply.action">我的分享申请</a></li>
 	<li><a href="productshare.action">分享审核</a></li>
</ul>
<div class="tab-content dr-tabs-panel">
<form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/product/manage/productshare!myapply.action" method="post">
...
<table class="table table-bordered dr-table-default">
	...
	<s:iterator value="page.result" status="stat">
		<tr>
			...
			<td>
				<s:if test="checked==0">
				<a href="${ctx }/product/manage/productshare!delete.action?ids=${id}">
