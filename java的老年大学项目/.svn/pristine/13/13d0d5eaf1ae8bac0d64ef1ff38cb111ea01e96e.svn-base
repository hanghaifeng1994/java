...
{
    private static final int maxcelllen = 32767 / 2;
    ...
    {
        if (maxcelllen < str.length())
        {
            return str.substring(0, maxcelllen) + "...";
        }
        return str;
    }
