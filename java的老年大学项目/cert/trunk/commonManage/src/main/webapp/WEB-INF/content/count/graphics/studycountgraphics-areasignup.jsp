...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        <li class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areasignup.action">报名学习情况</a></li>
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areaagesex.action">年龄性别比例</a></li>
    </ul>                
</div> 
...
<div class="form-group" <s:if test="cityId!=null">style="display: none;"</s:if> >
    ...
    <div class="form-group">
	  	<label>数据说明：地区学习率=地区学习人数/地区报名人数	</label>
	</div>
