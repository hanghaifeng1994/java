...
<!--信息提示 end-->
<form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/count/manage/jinsaistudentcount!areacount.action" method="post">
...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li class="active"><a style="cursor: pointer;" href="${ctx }/count/manage/jinsaistudentcount!areacount.action">参赛区域统计</a></li>
...
function initData(){ 
	var arrayValue =  new Array();
 	$.post("${ctx }/count/manage/jinsaistudentcount!getareacountdata.excsec?data="+$("#programesId").val(),function(data) {
 		for(p in data){
	 		arrayValue.push({
					name:p,
