...
<form id="form1" action="<s:if test="isIssue">product!productIssued.action</s:if><s:else>product!cancelIssued.action</s:else>" method="post" class="form-horizontal dr-form-bordered" role="form">
...
<div class="col-md-offset-2 col-md-10">
    ...
    <div class="btn-group">
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='product.action?tabFlag=isMy'">
