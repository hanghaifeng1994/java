...
import com.learnyeai.redislock.CacheLockInterceptor;
import com.learnyeai.redislock.RedisLockUtils;
			...
			threads[i] = new Thread(new  Runnable() {
				public void run() {
					try {
						...
						SeckillInterface proxy = (SeckillInterface) RedisLockUtils.getProxy(SeckillInterface.class, testClass);
