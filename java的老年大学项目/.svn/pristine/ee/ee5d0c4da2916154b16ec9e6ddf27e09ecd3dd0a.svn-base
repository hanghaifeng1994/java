...
public class UserCertOfflineService extends CacheEntityService<UserCertOffline, Long> {
	...
	public Map<String, CertplateVO> singleViewPrint(Long id) throws Exception {
		try {
			if (id != null) {
				...
				vo = this.getCertSubImagePrint(cert.getCertTemplate().getId(), valueOne, valueTwo, valueThree, valueFour, valueFive, valueSix, valueSeven, valueEight, valueNine, valueTen, valueEleven,imageOne,
	...
	public CertplateVO getCertSubImagePrint(Long certtemplateId, String valueOne, String valueTwo, String valueThree, String valueFour, String valueFive, String valueSix, String valueSeven,
			String valueEight, String valueNine, String valueTen, String valueEleven, String imageOne, String imageTwo, String imageThree, String imageFour, String imageFive, int imageOneWid, int imageOneHei,
		...
		if (certtemplateId != null) {
			...
			if (StringUtils.isNotBlank(cvo.getTextEleven())) {
				subject = subject.replace("\"" + cvo.getTextEleven() + "\"", "\"" + valueEleven + "\"");
			}
