...
<html>
<head>
<title>新增书籍<%@ include file="/common/title.jsp" %></title>
...
<form style="margin: 0px" class="form-horizontal dr-form-bordered" id="inputForm" name="inputForm" action="${ctx}/product/manage/product.action" method="post" enctype="multipart/form-data">
