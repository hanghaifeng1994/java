...
<h4 class="text-primary">请从辅导老师列表中选择</h4>
  ...
  <form class="form-inline dr-form-inline" id="mainForm" name="mainForm" action="${ctx}/course/manage/tutor!tutorUsers.action" method="post">
...
<form name="deleteForm" id="deleteForm" action="${ctx}/course/manage/tutor!tutorUsers.action" method="post">
<input type="hidden" name="tenantId" value="${tenantId}"/>
