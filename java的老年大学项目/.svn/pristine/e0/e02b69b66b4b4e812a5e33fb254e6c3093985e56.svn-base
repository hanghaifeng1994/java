...
<div class="z-content">
    <div class="made">
        <img class="img-responsive" src="cert/images/a12.png" alt="">
    </div>
</div>
                            ...
                            <div class="z-tab-content">
                                <div class="z-tab-item">
                                   ...
                                   <div class="container">
                                    ...
                                    <button class="z-btn z-btn-blue z-block" type="button" onClick="searchByMobile();" id="mobileBtn" disabled="disabled">查找</button>
                                ...
                                <div class="z-tab-item">
                                    ...
                                    <button class="z-btn z-btn-blue z-block" onClick="searchByIdcard();"  id="idcardBtn" type="button" disabled="disabled">查找</button>
                                </div>
                                <div class="z-tab-item">
                                    <!-- 	<select class="combo-select">
                                            <option value="">输入学校名称</option>
                                    ...
                                    <button class="z-btn z-btn-blue z-block" onClick="searchByName();"  id="nameBtn" type="button" disabled="disabled">查找</button>
                                </div>
