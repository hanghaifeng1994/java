...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        <li class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programshour.action">项目0-24学习人数</a></li>
...
<div class="form-group">
	  	<label>数据说明：不同项目某个时间段的总人数</label>
</div>
</div>       
...
function initData(){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getprogramshourcountdata.excsec?programesId="+$("#programesId").val(),function(data) {
