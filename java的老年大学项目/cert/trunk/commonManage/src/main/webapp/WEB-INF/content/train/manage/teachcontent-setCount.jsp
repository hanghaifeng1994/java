...
<body>
<form id="dataForm" action="${ctx}/train/manage/teachcontent!saveMost.action" method="post" class="form-inline dr-form-inline">
	<input type="hidden" name="id" value="${id}"></input>
  	...
  	<div class="form-group">
       <label>课程最大报名数:</label>
       <input  name="most" value="${most}" class="form-control input-sm" />
     </div>
