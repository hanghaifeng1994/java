...
<head>
<title>管理员管理-<s:if test="currentTenant!=null">${currentTenant.logo}</s:if><s:else><%@ include
			...
			<div class="dr-container-fluid">
				...
				<s:if test="nowUser.tenantId==null">
					...
					<ul class="nav nav-tabs nav-justified">
						<li
							...
							href="manager.action">大平台管理员 </a></li>
						<li class="<s:if test="tabFlag2=='other'">active</s:if>"><a
							href="manager.action?tabFlag2=other">租户管理员</a></li>
					</ul>
				</s:if>
				<div class="tab-content dr-tabs-panel">
					<form id="mainForm" name="mainForm" action="manager.action"
						...
						<div class="form-group">
								<label>用户名</label> <input class="form-control input-sm"
									type="text" id="susername" value="${username}">
							</div>
								<div class="form-group">
						...
						<div class="panel panel-default">
							<div class="btn-toolbar dr-btn-toolbar">
								<span class="fl">
									...
									<button class="btn btn-primary btn-sm" type="button"
										name="Submit3"
										onclick="window.location='manager!input.action'">
