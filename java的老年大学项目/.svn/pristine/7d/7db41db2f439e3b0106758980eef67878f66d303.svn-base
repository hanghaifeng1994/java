...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areaweek.action">地区一周学习人数</a></li>
...
function initData(){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getweekcountdata.excsec?areaId="+$("#areaId").val()+"&cityId="+$("#cityId").val()+"&tenantId=${currentTenant.id}",function(data) {
