		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input class="fileupload" id="shop-icon" type="file" data-url="${pageContext.request.contextPath}/resourceUpload" data-display-id="photo"	data-preview="true" data-rule-accept="image/*" />
					<%--<input class="fileupload" id="shop-icon" multiple type="file"
						   data-url="${pageContext.request.contextPath}/resourceUpload" data-display-id="photo"
						   data-is-file="true"  data-file-names="测试1.pdf,测试2.txt" data-rule-accept="image/*"/>--%>
