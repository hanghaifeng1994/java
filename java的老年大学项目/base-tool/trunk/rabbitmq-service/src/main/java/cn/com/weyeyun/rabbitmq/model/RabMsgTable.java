package cn.com.weyeyun.rabbitmq.model;
 ...
 * @author yl
 */
public class RabMsgTable extends BaseEntity {
    ...
    */
    ...
    public static class TF {
        ...
        public static String TABLE_NAME = "RAB_MSG_TABLE";   // 表名
        ...
        public static String dealStatus = "DEAL_STATUS";  // 消费者处理：0未处理、1成功、2失败、3死信队列，如果是死信定时发送
