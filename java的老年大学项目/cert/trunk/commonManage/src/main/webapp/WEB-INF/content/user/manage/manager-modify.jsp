...
$(function(){
	...
	api.load('${ctx}','SellApiWeb/api/manage/shopuser/detail.do','detailTemplate','detail')
	...
	$("#btnsave").click(function (){
		...
		api.exec('${ctx}','SellApiWeb/api/manage/shopuser/modify.do',function (){window.location.href='manager.action';})
		}
	)
});
</script>
