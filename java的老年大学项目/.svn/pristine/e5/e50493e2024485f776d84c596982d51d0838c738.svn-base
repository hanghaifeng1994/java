...
<html>
<head>
<title>编辑优惠码规则信息-<s:if test="currentTenant!=null">${currentTenant.logo}</s:if><s:else><%@ include file="/common/title.jsp" %></s:else></title>
...
<!--adminLeft结束-->
  ...
  <div class="dr-container-fluid">
    <ol class="dr-breadcrumb">
     ...
     <li class="active">
        <span class="deep_bule">编辑普通优惠码规则 </span>
     </li>
    </ol>
...
<form id="inputForm" name="inputForm" class="form-horizontal dr-form-bordered" 
  ...
  <div class="dr-form-title clearfix">
    <div class="col-md-12">
    <h4 class="text-primary">更改优惠码规则信息</h4>
    </div>
   </div>
   <div id="detail">
...
$(function(){
	...
	api.load('${ctx}','SellApiWeb/api/manage/coupon/detail.do','detailTemplate','detail',inittime)
	...
	$("#btnsave").click(function (){
		...
		api.exec('${ctx}','SellApiWeb/api/manage/coupon/modify.do',function (){window.location.href='coupon.action';})
		}
	)
});
</script>
