...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areaphasecomplete.action">项目阶段合格率</a></li>
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areaprogramscomplete.action">项目合格率</a></li>
...
<div class="form-group" style="float: left"> 
	...
	<div class="form-group">
		  	<label>所属项目</label>
		  	<s:select list="programesLists" listKey="id" value="programesId" listValue="name" theme="simple"  onchange="loadHighchart();"
				 cssClass="form-control" name="programesId"></s:select>
	</div>
	
	
    <div class="form-group">
	  	<label>数据说明：项目阶段合格率=项目阶段合格人数/项目阶段报名人数	</label>
	</div>
</div>       
...
function loadHighchart() {
	...
	$('#container').highcharts({
        ...
        xAxis: [{
            //categories:["阶段一","阶段二"]
            categories:arrayValue.phaseName
        }],
        yAxis: [{ 
            labels: {
                format: '{value}个',
...
function initData(){ 
 	$.post("${ctx }/count/graphics/studycountgraphics!getPhaseJieyeHighchartData.excsec",{programesId:$("#programesId").val()},function(data) {
 		arrayValue.phaseName =  data.diqu;
