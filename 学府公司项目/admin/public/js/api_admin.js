(function (window) {
    ...
    let file_service = 'http://115.159.99.212:9019/file-service/',//文件上传服务
        file = {
    ...
    let activity_service = "http://115.159.99.212:9026/activity-service/",//活动
        activity = {
    ...
    let show_service = 'http://115.159.99.212:9015/show-service/',//才艺服务
        show = {
            ...
            "albumCateQueryById": "api/abmCategory/queryById.do",//分类详情
            "albumCateSave": "api/abmCategory/save.do",//分类新增
        };
    ...
    let notice_service = 'http://115.159.99.212:9016/notice-service/',//通知服务
        notice = {
            "save": "api/newsArticle/save.do",//新增和修改保存
            "delete": "api/newsArticle/delete.do",//批量删除
            "queryById": "api/newsArticle/queryById.do",//详情获取
    ...
    let help_service = 'http://115.159.99.212:9017/help-service/',//帮助/知识点
        help = {
            "save": "api/newsArticle/save.do",//新增和修改保存
            "delete": "api/newsArticle/delete.do",//批量删除
            "queryById": "api/newsArticle/queryById.do",//详情获取
    ...
    let studygroup_serice = 'http://115.159.99.212:9027/studygroup-service/',//学习小组服务
        studygroup = {
    ...
    let testing_service = "http://115.159.99.212:8096/testing-service/", //测验服务
        testing = {
    ...
    let setting_service = 'http://115.159.99.212:9013/setting-service/',//配置服务
        setting = {
    ...
    let exp_service = "http://115.159.99.212:9018/exp-service/",//经验
        exp = {
            "save": "api/newsArticle/save.do",//新增和修改保存
            "delete": "api/newsArticle/delete.do",//批量删除
            "queryById": "api/newsArticle/queryById.do",//详情获取
    ...
    let orderform_service = "http://115.159.99.212:8097/orderform-service/",//订单
        orderform = {
            "orderformlist": "api/ordOrderform/queryManagePage.do",//订单-可管理列表
        };
    returnapi(orderform, orderform_service);

    let resultbill_service = "http://115.159.99.212:9028/resultbill-service/",//订单
        resultbill = {
