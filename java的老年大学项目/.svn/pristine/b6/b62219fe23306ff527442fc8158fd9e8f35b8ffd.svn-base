...
<!--正文左边开始-->
	...
	<jsp:param value="input-productcategory" name="menu" />
...
<li class="active"><s:if test="id == null">新增</s:if><s:else>编辑</s:else>书籍分类
</li>
</ol>

<div class="dr-page-header">
<h3>
<s:if test="id == null">新增</s:if><s:else>编辑</s:else>书籍分类
</h3>
</div>
<hr/>
<div class="panel panel-default">
<form id="form1" action="productcategory!save.action" method="post" class="form-horizontal dr-form-bordered" role="form">
<input type="hidden" name="id" value="${id}" />
<div class="dr-form-title clearfix">
<div class="col-md-12">
<h4 class="text-primary">书籍分类基本信息</h4>
</div>
</div>
...
<div class="form-group">    
		...
		<div class="col-md-3" id="col-md">
		 ...
		 <iframe src="${ctx}/product/manage/productcategory!uploadphoto.action?picfileFileName=${pic}" frameborder="0" width="100%" height="810" scrolling="no"></iframe>
		 </div>
		<s:if test="pic!=null">
...
<div class="col-md-offset-2 col-md-10">
    ...
    <div class="btn-group">
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='productcategory.action?parentId=${parentId}&isMy=${isMy}'">
