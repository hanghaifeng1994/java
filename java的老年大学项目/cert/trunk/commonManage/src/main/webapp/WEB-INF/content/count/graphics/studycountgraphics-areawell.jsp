...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!areawell.action">地区优秀情况</a></li>
...
<div class="form-group" <s:if test="cityId!=null">style="display: none;"</s:if> >
    ...
    <div class="form-group">
	  	<label>数据说明：地区优秀率=地区优秀人数/地区报名人数	</label>
	</div>
...
function loadHighchart(){
	...
	var chart = new Highcharts.Chart({
        ...
        xAxis: {
        	//categories:["江阴","南长","北塘","崇安","滨湖","惠山","崇安","锡山","新区","宜兴"]
        ...
        series: [
						{
							...
							type: 'column',
							yAxis: 0,
							//data:[2,2,3,1,5,1,5,7,3,3],
							data:arrayValue.perfectNum,
				            zIndex:999
						}, {
							name: '合格',
							color:"#89A54E",
...
function initData(){ 
 	$.post("${ctx }/count/graphics/studycountgraphics!getdiquStudyHighchartData.excsec",{cityId:$("#cityId").val(),areaId:'${areaId}',filter:'${filter}',tenantId:'${currentTenant.id}'},function(data) {
		...
		arrayValue.perfectNum = parseIntArray(data.perfectNum);
		arrayValue.perfectRate = parseIntArray(data.perfectRate);
 	});
 	return arrayValue; 
}
