...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="13%" class="tt_line">状态</td>
		<td width="8%" class="tt_line">自主班级</td>
		<td width="8%" class="tt_line">集体班级</td>
		<td width="20%" class="tt_line">操作</td>
	</tr>
	<s:iterator value="publicpage.result" status="stat">
		<tr>
			<td class="white_bg"><input type="checkbox" name="ids"
				value="${id}" /></td>
			<td class="white_bg"><a href="#">${progarmDTO.name}</a></td>
			<td class="white_bg">${progarmDTO.code}</td>
			<td class="white_bg">&nbsp;${progarmDTO.statusStr}</td>
			<td class="white_bg">&nbsp;${progarmDTO.selfClazzCount}</td>
			<td class="white_bg">&nbsp;${progarmDTO.groupClazzCount}</td>
			<td class="white_bg">
