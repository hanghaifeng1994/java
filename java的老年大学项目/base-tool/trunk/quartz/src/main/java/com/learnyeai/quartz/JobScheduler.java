 ...
 *
 */
public class JobScheduler implements com.learnyeai.quartz.IJobScheduler {
    ...
    public JobScheduler() {
        scheduler = SpringContextUtils.getBean("Scheduler");
    }
    public JobScheduler(JobDetail jobDetail) {
        this();
        this.jobDetail = jobDetail;
    }
    ...
    public boolean removeJob(String jobName) {
        return removeJob(jobName, NULLSTRING);
    }
