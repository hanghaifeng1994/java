...
import cn.com.weye.core.persistence.TreeExtEntity;
 ...
 * @version 2016-09-14
 */
public class TestTree extends TreeExtEntity<TestTree> {
	...
	{
		return ConfigUtils.getValue("schema.configPlat") + ".test_tree";
	}
