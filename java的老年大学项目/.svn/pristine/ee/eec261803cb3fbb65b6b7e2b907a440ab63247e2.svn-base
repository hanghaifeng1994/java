...
public class OrdOrderform extends BaseEntity {
	...
	private List<OrdOrderformDetail> details = new ArrayList<OrdOrderformDetail>();
	...
	public static class TF {
		...
		public static String realPrice = "REAL_PRICE"; // 订单实收
	...
	public List<OrdOrderformDetail> getDetails() {
		return details;
	}

	public void setDetails(List<OrdOrderformDetail> details) {
