...
public class StringUtil {
	 ...
	 * **/
	private static final String CHINA_TELECOM_PATTERN = "(^1(33|53|7[37]|8[019]|99)\\d{8}$)|(^1700\\d{7}$)";

	/**
	 * 中国联通号码格式验证 手机段：130,131,132,155,156,185,186,145,171,175,176,1707,1708,1709
	 * **/
	private static final String CHINA_UNICOM_PATTERN = "(^1(3[0-2]|4[5]|5[56]|66|7[1]|7[5]|7[6]|8[56])\\d{8}$)|(^170[7-9]\\d{7}$)";
	 ...
	 **/
	private static final String CHINA_MOBILE_PATTERN = "(^1(3[4-9]|4[7]|5[0-27-9]|7[2]|7[8]|8[2-478]|98)\\d{8}$)|(^1705\\d{7}$)";
