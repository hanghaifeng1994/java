...
var menus = [
    // 00基础服务
    {
        ...
        name : "站点小组分类列表-f",
        url : "api/sgpCategory/queryShowPage.do",
        path : "api/sgpCategory/queryShowPage",
        clazz : "PP00"
    },{
        name : "小组-可管理的小组列表查询",
        ...
        name : "学习小组-列表(根据多个才艺id查询)",
        url : "api/sgpStudyGroup/queryPageByCyId.do",
        path : "api/sgpStudyGroup/queryPageByCyId",
        clazz : "PP01"
    },{
        name : "学习小组-列表(根据多个经验id查询)",
        url : "api/sgpStudyGroup/queryPageByExpId.do",
        path : "api/sgpStudyGroup/queryPageByExpId",
        clazz : "PP01"
    },{
        name : "学习小组-小组成员列表",
        ...
        name : "经验-小组才艺删除",
        url : "api/sgpStudyGroupTalent/delete.do",
        path : "api/sgpStudyGroupTalent/delete",
        clazz : "PP01"
    },{
        name : "小组才艺-保存",
        ...
        name : "经验-小组经验删除",
        url : "api/sgpStudyGroupExperience/delete.do",
        path : "api/sgpStudyGroupExperience/delete",
        clazz : "PP01"
    },{
        name : "新增小组经验",
