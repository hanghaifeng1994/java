...
<div id="message"><s:actionmessage theme="custom"
	cssClass="tipbox" /></div>
<form id="form1" action="teachplan!save.action" method="post"><input
	type="hidden" name="id" value="${id}" />
<div id="news_edit" class="form input mb20">
<ul>
	<li><label style="width: 95px;"> 项目类型&nbsp; </label>
	${itemcategory.Name }<span class="ml10 font999"> </span></li>


	<li><label style="width: 95px;"> 培训项目名称&nbsp; </label> ${name}</li>

	<li><label style="width: 95px;"> 培训项目代码&nbsp; </label> ${code} <span
		class="ml10 font999"> <strong id="error_code"></strong> </span></li>

	<li><label style="width: 95px;"> 学制&nbsp; </label>
	${trainingPrograms.xuezhi } <span class="ml10 font999"> <strong
		id="error_descr"></strong> </span></li>
	<li><label style="width: 95px;">毕业时要求&nbsp; </label>
	${trainingPrograms.hours} 学分/年<span class="ml10 font999"> </span></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	class="tablebg font333 ll collapse">
	<tr>
...
<div class="pager rr"><jsp:include page="/common/turnpage.jsp"></jsp:include>
<div class="tc" style="text-align: left; width: 120px; float: left;"><input
	class="button01" type="submit" value="新增年度教学计划" /></div>
</div>
</div>
</form>
</div>
