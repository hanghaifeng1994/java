...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!clazzavgsocore.action">班级平均成绩</a></li>
    </ul>                
</div> 
...
<div class="form-group"> 
	...
	<div class="form-group">
	  	<label>数据说明：班级平均成绩=班级学员总成绩/班级学员学习人数	</label>
	</div>
</div>       
...
function loadHighchart(){	
	    $('#container').highcharts({
	        ...
	        title: {
	            text: $('#programesId :selected').text()+'班级平均成绩柱状图 ',
				style: {
					color: '#4572A7' 
				}
	        },
...
function initData(){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getclazzscorecountdata.excsec?programesId="+$("#programesId").val()+"&scoretype=7",function(data) {
