...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        <li><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programSignup.action">项目报名学习情况</a></li>
        <li class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!programAgeSex.action">项目年龄性别比例</a></li>
    </ul>                
</div> 
...
function changeTenant(){				
 ...
 function initData(){ 
	 	$.post("${ctx }/count/graphics/studycountgraphics!getProgramAgeSexdata.excsec",{tenantId:$("#tenantId").val(),programesId:$("#programesId").val()},function(data) {
