...
public class ResCategory extends BaseEntity {
	...
	@Transient
	private List<ResCategory> childs = new ArrayList<ResCategory>();
	...
	public static class TF {
		...
		public static String TABLE_NAME = "RES_CATEGORY"; // 表名
	...
	public List<ResCategory> getChilds() {
		return childs;
	}

	public void setChilds(List<ResCategory> childs) {
		this.childs = childs;
	}
