		...
		<div class="tab-content dr-tabs-panel">
			...
			<table class="table table-bordered dr-table-bordered">
				...
				<tr>
			      <td>大平台</td>
			      <td>
			      <a href="${ctx}/module/manage/moduleconfig!input.action?id=" class="btn btn-primary btn-sm">
			    ...
			    <tr>
			      <td>${logo}</td>
			      <td>
			      <a href="${ctx}/module/manage/moduleconfig!input.action?id=${id}" class="btn btn-primary btn-sm">
			      <span class="glyphicon glyphicon-edit"></span>&nbsp;功能模块配置</a>
			      </td>
			    </tr>
			    </s:iterator> 
