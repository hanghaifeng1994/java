...
//	private GenTemplateDao genTemplateDao;
	...
	private String generateCode(GenScheme genScheme){
		...
		// 获取物理表列表
		if(genTable.getDbSchema().equals(Global.getConfig("schema.configPlat")))
			genTable.setDbSchema("schema.configPlat");
		else
			genTable.setDbSchema("schema.interPlat");
		...
		for (GenTable childTable : genTable.getChildList()){
			if(childTable.getDbSchema().equals(Global.getConfig("schema.configPlat")))
				childTable.setDbSchema("schema.configPlat");
			else
				childTable.setDbSchema("schema.interPlat");
