...
<div class="bs-example" > 
	<ul class="nav nav-tabs nav-justified" id="tab">
        ...
        <li  class="active"><a style="cursor: pointer;" href="${ctx }/count/graphics/studycountgraphics!agestudytime.action">年龄段电脑和app学习时间</a></li>
...
function initData(studytype){  
	...
	$.post("${ctx }/count/graphics/studycountgraphics!getagestudytimecountdata.excsec?areaId="+$("#areaId").val()+"&cityId="+$("#cityId").val()+"&studytype="+studytype+"&tenantId=${currentTenant.id}",function(data) {
