...
<html>
<head>
<title>新增佣金码规则信息-<s:if test="currentTenant!=null">${currentTenant.logo}</s:if><s:else><%@ include file="/common/title.jsp" %></s:else></title>
...
<!--adminLeft结束-->
  ...
  <div class="dr-container-fluid">
    <ol class="dr-breadcrumb">
     ...
     <li><a href="#">佣金码佣金规则管理</a></li>
     <li class="active">
        <span class="deep_bule">新增佣金码规则 </span>
     </li>
    </ol>
...
<form id="inputForm" name="inputForm" class="form-horizontal dr-form-bordered" 
  ...
  <div class="dr-form-title clearfix">
    <div class="col-md-12">
    <h4 class="text-primary">新增佣金码规则基本信息</h4>
    </div>
   </div>
   <div id="detail">
   <div class="form-group" id="validate_username">
     ...
     <div class="form-group" id="validate_name">
	    ...
	    <div class="col-md-3">
	      <textarea id="ruledesc" name="ruledesc" class="form-control" style="width:500px; height:120px;"></textarea>
        </div>
        <span class="help-block" id="error_name"></span>
     </div>
     <div class="form-group" id="validate_name">
	    ...
	    <div class="col-md-3">
	      <textarea id="senddesc" name="senddesc" class="form-control" style="width:500px; height:120px;"></textarea> 
        </div>
        <span class="help-block" id="error_name"></span>
     </div>
      ...
      <div class="form-group" id="validate_name">
	    ...
	    <div class="col-md-3">
	        <input id="telephone" name="telephone" type="text" value="" class="form-control"/> 
        </div>
        <span class="help-block" id="error_name"></span>
     </div>
...
$(function(){
	$("#btnsave").click(function (){
		...
		api.exec('${ctx}','SellApiWeb/api/manage/commision/add.do',function (){window.location.href='commision.action';})
		}
	)
});
</script>
