...
public class CmsUtils {
	...
	public static List<Site> getSiteList(){
		...
		List<Site> siteList = CacheUtils.getCacheVal(CMS_CACHE, "siteList");
		if (siteList == null){
	...
	public static List<Category> getMainNavList(String siteId){
		@SuppressWarnings("unchecked")
		List<Category> mainNavList = CacheUtils.getCacheVal(CMS_CACHE, "mainNavList_"+siteId);
		if (mainNavList == null){
	...
	public static Object getCache(String key) {
		return CacheUtils.getCacheVal(CMS_CACHE, key);
	}
	...
	public static void removeCache(String key) {
		CacheUtils.getCache(CMS_CACHE).evict(key);
	}
