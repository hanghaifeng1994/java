...
<body>
	...
	<form:form id="inputForm" modelAttribute="orderComplaint" action="${ctx}/ordercomplaint/orderComplaint/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="title" htmlEscape="false" maxlength="20" disabled="disabled" class="input-xlarge"  />
            </div>
        </div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="cmtContent" htmlEscape="false" maxlength="2000" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
                ...
                <input class="fileupload" id="photo" type="file" data-url="${ctx}/resourceUpload" data-display-id="photo"
