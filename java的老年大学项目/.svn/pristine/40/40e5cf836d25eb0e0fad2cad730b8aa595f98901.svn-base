...
public class BizQueueConfig {
    ...
    public DirectExchange businessExchange() {
        return new DirectExchange(AuditlogConstans.AUDITLOG_EXCHANGE);
    }
   ...
   public Queue bizQueue() {
	   ...
	   return new Queue(AuditlogConstans.AUDITLOG_QUEUE,true,false,false,arguments);
   }
   ...
   public Binding bizBinding() {
       return BindingBuilder.bind(bizQueue()).to(businessExchange())
               .with(AuditlogConstans.AUDITLOG_KEY);
   }
