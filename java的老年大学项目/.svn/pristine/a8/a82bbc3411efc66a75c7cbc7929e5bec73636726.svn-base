...
<!--正文左边开始-->
	...
	<jsp:param value="change-product" name="menu" />
...
<form style="margin: 0px" class="form-horizontal dr-form-bordered" id="inputForm" name="inputForm" action="product!productsave.action" method="post">
...
<div class="col-md-12">
<h4 class="text-primary">租户书籍属性设置</h4>
</div>
</div>
<div class="form-group" id="validate_isdiplay">
    <label class="col-md-3 control-label">显示其他租户开放书籍<span class="text-danger">*</span></label>
    ...
    <span class="text-danger" id="error_productPermission"></span>
</div>
</div>

<div class="form-group" id="validate_display">
    <label class="col-md-3 control-label">开放私有书籍给其它租户<span class="text-danger">*</span></label>
    <div class="col-md-5 mt5">
...
<div class="col-md-offset-2 col-md-10">	
		...
		<button name="Submit32" class="btn btn-default btn-sm" type="button" onclick="window.location.href='product.action'">
